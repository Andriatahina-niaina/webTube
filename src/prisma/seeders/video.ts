...
const createVideoData = (categories: CategorieOutput[]): VideoInput[] => [
  {
    title: "Clip musical 1",
    url: "https://musique1.com",
    categorieId: categories.find((c) => c.name === "Musique")?.id ?? 0,
  },
  {
    title: "Tuto programmation",
    url: "https://tech.com",
    categorieId: categories.find((c) => c.name === "Technologie")?.id ?? 0,
  },
  {
    title: "Voyage à Bali",
    url: "https://voyage.com",
    categorieId: categories.find((c) => c.name === "Voyage")?.id ?? 0,
  },
  {
    title: "Blague marrante",
    url: "https://humour.com",
    categorieId: categories.find((c) => c.name === "Humour")?.id ?? 0,
  },
  {
    title: "Cours de maths",
    url: "https://education.com",
    categorieId: categories.find((c) => c.name === "Éducation")?.id ?? 0,
  },
];
